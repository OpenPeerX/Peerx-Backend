...
- **Settlement** — the final, irreversible transfer of an asset between
  two parties on-chain.
- **LP** — Liquidity Provider; contributes assets to a PeerX pool.
- **KYC Issuer** — the on-chain issuer DID that signs verifiable
  credentials (`did:ethr:0xPeerXKycIssuer000000`).
